...
class SniperDaemonService:
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        session_started_slot: int | None = None,
    ) -> None:
        ...
        self._session_started_slot = session_started_slot
    ...
    async def _handle_locked_launch(  # noqa: C901, PLR0911
        ...
        if (
            self._session_started_slot is not None
            and launch.slot < self._session_started_slot
        ):
            return self._result(
                SniperStage.IDLE,
                "launch slot occurred before session startup freshness boundary",
            )
