...
def build_finalized_trades_from_observations(
    *,
    ...
    from rugbot.ingest.pump.pump_swap_trade_observation import (  # noqa: PLC0415
        decode_pump_swap_trade_observation,
    )
    from rugbot.ingest.pump.pump_trade_observation import (  # noqa: PLC0415
...
def build_finalized_pump_swap_trade(
    *,
    ...
    from rugbot.ingest.pump.pump_swap_event_observation import (  # noqa: PLC0415
